...
class InsuranceplansController extends Controller {
	...
	public $module = 'insuranceplans';
	static $per_page	= '50';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Insuranceplans();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'insuranceplans',
		...
		switch ($task)
		{
			default:
				...
				if ($validator->passes()) 
				{
					...
					$data['sort_position'] = $request->sort_position;
	...
	public static function display(  )
	{
		...
		$model  = new Insuranceplans();
		$info = $model::makeInfo('insuranceplans');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('insuranceplans.public.view',$data);			
			}			
		} 
		else {
			...
			return view('insuranceplans.public.index',$data);	
		}
