...
class VisitreportsController extends Controller {
	...
	public $module = 'visitreports';
	static $per_page	= '50';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Visitreports();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'visitreports',
	...
	public static function display(  )
	{
		...
		$model  = new Visitreports();
		$info = $model::makeInfo('visitreports');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('visitreports.public.view',$data);			
			}			
		} 
		else {
			...
			return view('visitreports.public.index',$data);	
		}
