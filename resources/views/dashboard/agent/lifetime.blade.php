...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-12 text-center mt-4 mb-4 text-uppercase">
            <h2>Lifetime Statistics @if($checked_user) <br><span>For <br><strong style="color:#dc3545">{{$checked_user->first_name}}</strong></span>@endif</h2>
        </div>
    </div>
    <div class="row mb-5">
            ...
            <div class="col-md-2 pl-0 pr-1">
                <button class="filter_btn" type="submit">
                    <div class="seach_filer text-center">
                        ...
                        @endif
                        <input type="hidden" name="report" value="lifetime">
