...
<div class="toolbar-nav" >   
	<div class="row">
		<div class="col-md-8"> 	
			@if($access['is_add'] ==1)
			<a href="{{ url('visitreports/create?return='.$return) }}" class="btn btn-default btn-sm"  
			...
			<div class="btn-group">
				...
				@if($access['is_add'] ==1)
					...
					<li class="nav-item"><a href="{{ url($pageModule .'/import?return='.$return) }}" onclick="ConcaveModal(this.href, 'Import CSV'); return false;" class="nav-link "> Import CSV</a></li>
		...
		<div class="col-md-4 text-right">
			<div class="input-group ">
			      <div class="input-group-prepend">
			        ...
			        onclick="ConcaveModal('{{ url($pageModule."/search") }}','Advance Search'); " ><i class="fa fa-filter"></i> Filter </button>
			      </div><!-- /btn-group -->
...
<div class="table-container">
			...
			<!-- Table Grid -->
 			...
 			{!! Form::open(array('url'=>'visitreports?'.$return, 'class'=>'form-horizontal m-t' ,'id' =>'ConcaveTable' )) !!}
							...
							<td>
							 	...
							 	<div class="dropdown">
								  ...
								  <ul class="dropdown-menu">
									...
									<li class="nav-item"><a href="{{ url('visitreports/'.$row->id.'?return='.$return)}}" class="nav-link tips" title="{{ __('core.btn_view') }}"> {{ __('core.btn_view') }} </a></li>
									@endif
									@if($access['is_edit'] ==1)
									<li class="nav-item"><a  href="{{ url('visitreports/'.$row->id.'/edit?return='.$return) }}" class="nav-link  tips" title="{{ __('core.btn_edit') }}"> {{ __('core.btn_edit') }} </a></li>
									@endif
									<div class="dropdown-divider"></div>
									@if($access['is_remove'] ==1)
										<li class="nav-item"><a href="javascript://ajax"  onclick="ConcaveDelete();" class="nav-link  tips" title="{{ __('core.btn_remove') }}">
